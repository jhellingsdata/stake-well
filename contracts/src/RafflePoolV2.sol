...
contract RafflePool is VRFConsumerBaseV2, Ownable {
    ...
    //////////// Raffle V2 State Variables ////////////
    // Mapping of user => snapshotIndex => balance at that snapshot
    mapping(address => mapping(uint256 => uint256)) private
        s_userSnapshotBalances;

    // Mapping of user => their last processed snapshot
    mapping(address => uint256) private s_lastProcessedSnapshot;

    // Current snapshot index (rotates 0 through 6 for a week)
    uint256 private s_currentSnapshotIndex = 0;
    ///////////////////////////////////////////////////
